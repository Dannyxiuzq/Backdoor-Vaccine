...
def get_llm(model_name, lora_path=None, cache_dir="llm_weights"):
    # Load the base model
    ...
    # If a LoRA path is provided, load and merge LoRA weights
    if lora_path:
...
def main():
    ...
    print(f"loading lora model {args.lora_path}")
    model = get_llm(args.model, args.lora_path, args.cache_dir)
    model.eval()
